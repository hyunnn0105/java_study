...
public class Bj13023 {
  ...
  2. 따라서 인접리스트로 그래프를 구성한 후 DFS를 수행합니다. -> 입력값으로 인접리스트 구현
 ...
 */
    ...
    // 총 8명이면 8개짜리 배열로 -> false 값으로 채운다음 true로 바꾸기
    // else -> return new visted[]
    ...
    static void DFS(int num, int level) {
        ...
        visited[num] = false; // 재귀 전 단계로 복귀시에 방문기록을 리셋 -> 다른 애들이랑 친구일수도 있음
    }
